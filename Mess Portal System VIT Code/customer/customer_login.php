...
<body>
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form action="checkout.php" method="post" class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
					<input class="input100" type="text" name="c_email" placeholder="username or email">
				...
				<div class="text-center">
					<a href="admin_area/login.php" class="txt2 hov1">
	...
	if(isset($_POST['c_login']))
	{
		...
		$pass=$_POST['c_pass'];
		$sqllog="select * from customers where customer_email='$email'and customer_pass='$pass'";
		$sqllogrun=mysqli_query($con,$sqllog);
		if(mysqli_num_rows($sqllogrun)>0)
		{
